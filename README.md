# RComPlEx-NG: Co-Expressolog Discovery Pipeline
...
- ✅ **Input validation**: Infers tissues from data, validates config in 10 seconds
- ✅ **Config-driven species**: Edit YAML instead of hardcoding in Nextflow
- ✅ **Robust file handling**: Explicit pair_id in filenames (03_Sp1_Sp2.RData)
- ✅ **Smart restart**: Aggressive caching (`cache = 'lenient'`) for pipeline resumption
- ✅ **Documentation cleanup**: Consolidated to single README
