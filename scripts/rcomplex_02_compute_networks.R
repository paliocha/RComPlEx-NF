#!/usr/bin/env Rscript
# ==============================================================================
# RComPlEx Step 2: Compute Co-Expression Networks (Per-Pair)
# ==============================================================================
# Computes correlation matrices for a species pair, applies normalization
# (CLR or MR), and determines density thresholds.
# Networks are computed on the pair-specific gene set (genes with orthologs
# in this specific pair), matching the original RComPlEx.Rmd logic.
# ==============================================================================
...
cat("\n")
cat(rep("=", 80), "\n", sep = "")
cat("RComPlEx Step 2: Compute Co-Expression Networks (Per-Pair)\n")
cat(rep("=", 80), "\n", sep = "")
...
cat("  Matrix size: ~", nrow(species1_expr), "x", nrow(species1_expr),
    " and ~", nrow(species2_expr), "x", nrow(species2_expr), "\n")
...
output_file <- file.path(opt$outdir, "02_networks.qs2")
cat("Saving networks to:", output_file, "\n")
qs_save(list(
  species1_net = species1_net,
  species2_net = species2_net,
  species1_thr = species1_thr,
  species2_thr = species2_thr,
